...
!function (e, t) {
  ...
  function r(e) {
    var t = !!e && "length" in e && e.length,
        n = i(e);
    return !ve(e) && !xe(e) && ("array" === n || 0 === t || "number" == typeof t && t > 0 && t - 1 in e);
  }
  ...
  function u(e) {
    var t = {};
    return we.each(e.match(_e) || [], function (e, n) {
      t[n] = !0;
    }), t;
  }
  ...
  function v(e, t, n, i) {
    ...
    if (c && c[3] !== l) {
      for (u /= 2, l = l || c[3], c = +u || 1; s--;) {
        we.style(e, t, c + l), (1 - o) * (1 - (o = a() / u || .5)) <= 0 && (s = 0), c /= o;
      }
  ...
  function x(e) {
    var t,
        ...
        i = e.nodeName,
        r = Ge[i];
    return r || (t = n.body.appendChild(n.createElement(i)), r = we.css(t, "display"), t.parentNode.removeChild(t), "none" === r && (r = "block"), Ge[i] = r, r);
  }

  function b(e, t) {
    for (var n, i, r = [], o = 0, s = e.length; o < s; o++) {
      (i = e[o]).style && (n = i.style.display, t ? ("none" === n && (r[o] = Pe.get(i, "display") || null, r[o] || (i.style.display = "")), "" === i.style.display && Ye(i) && (r[o] = x(i))) : "none" !== n && (r[o] = "none", Pe.set(i, "display", n)));
    }
  ...
  function C(e, t, n, r, o) {
    for (var s, a, u, l, c, f, d = t.createDocumentFragment(), p = [], h = 0, g = e.length; h < g; h++) {
      if ((s = e[h]) || 0 === s) if ("object" === i(s)) we.merge(p, s.nodeType ? [s] : s);else if (Ze.test(s)) {
        for (a = a || d.appendChild(t.createElement("div")), u = (Ve.exec(s) || ["", ""])[1].toLowerCase(), l = Ke[u] || Ke._default, a.innerHTML = l[1] + we.htmlPrefilter(s) + l[2], f = l[0]; f--;) {
          a = a.lastChild;
        }

        we.merge(p, a.childNodes), (a = d.firstChild).textContent = "";
      } else p.push(t.createTextNode(s));
    }

    for (d.textContent = "", h = 0; s = p[h++];) {
      if (r && we.inArray(s, r) > -1) o && o.push(s);else if (c = we.contains(s.ownerDocument, s), a = w(d.appendChild(s), "script"), c && T(a), n) for (f = 0; s = a[f++];) {
  ...
  function q(e, t, i, r) {
    ...
    var o,
        ...
        h = t[0],
        g = ve(h);
    if (g || d > 1 && "string" == typeof h && !ye.checkClone && st.test(h)) return e.each(function (n) {
      var o = e.eq(n);
      g && (t[0] = h.call(this, n, o.html())), q(o, t, i, r);
    });

    if (d && (o = C(t, e[0].ownerDocument, !1, e, r), s = o.firstChild, 1 === o.childNodes.length && (o = s), s || r)) {
      for (u = (a = we.map(w(o, "script"), j)).length; f < d; f++) {
        l = o, f !== p && (l = we.clone(l, !0, !0), u && we.merge(a, w(l, "script"))), i.call(e[f], l, f);
      }

      if (u) for (c = a[a.length - 1].ownerDocument, we.map(a, L), f = 0; f < u; f++) {
        l = a[f], Je.test(l.type || "") && !Pe.access(l, "globalEval") && we.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? we._evalUrl && we._evalUrl(l.src) : n(l.textContent.replace(at, ""), c, l));
      }
    }
  ...
  function O(e, t, n) {
    for (var i, r = t ? we.filter(t, e) : e, o = 0; null != (i = r[o]); o++) {
      n || 1 !== i.nodeType || we.cleanData(w(i)), i.parentNode && (n && we.contains(i.ownerDocument, i) && T(w(i, "script")), i.parentNode.removeChild(i));
    }
  ...
  function I(e, t, n) {
    var i,
        ...
        s,
        a = e.style;
    return (n = n || lt(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || we.contains(e.ownerDocument, e) || (s = we.style(e, t)), !ye.pixelBoxStyles() && ut.test(s) && ct.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s;
  }
  ...
  function R(e, t, n, i, r, o) {
    ...
    for (; s < 4; s += 2) {
      "margin" === n && (u += we.css(e, n + Ue[s], !0, r)), i ? ("content" === n && (u -= we.css(e, "padding" + Ue[s], !0, r)), "margin" !== n && (u -= we.css(e, "border" + Ue[s] + "Width", !0, r))) : (u += we.css(e, "padding" + Ue[s], !0, r), "padding" !== n ? u += we.css(e, "border" + Ue[s] + "Width", !0, r) : a += we.css(e, "border" + Ue[s] + "Width", !0, r));
    }
  ...
  function M(e, t, n) {
    ...
    return s = s && (ye.boxSizingReliable() || r === e.style[t]), ("auto" === r || !parseFloat(r) && "inline" === we.css(e, "display", !1, i)) && (r = e["offset" + t[0].toUpperCase() + t.slice(1)], s = !0), (r = parseFloat(r) || 0) + R(e, t, n || (o ? "border" : "content"), s, i, r) + "px";
  }
  ...
  function F() {
    vt && (!1 === se.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(F) : e.setTimeout(F, we.fx.interval), we.fx.tick());
  }
  ...
  function X(e, t, n) {
    ...
    if ((u = !we.isEmptyObject(t)) || !we.isEmptyObject(p)) {
      f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = m && m.display) && (l = Pe.get(e, "display")), "none" === (c = we.css(e, "display")) && (l ? c = l : (b([e], !0), l = e.style.display || l, c = we.css(e, "display"), b([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === we.css(e, "float") && (u || (d.done(function () {
        h.display = l;
      ...
      for (i in p) {
        u || (m ? "hidden" in m && (g = m.hidden) : m = Pe.access(e, "fxshow", {
          display: l
        }), o && (m.hidden = !g), g && b([e], !0), d.done(function () {
          g || b([e]), Pe.remove(e, "fxshow");

          for (i in p) {
            we.style(e, i, p[i]);
          }
        })), u = Y(g ? m[i] : 0, i, d), i in m || (m[i] = u.start, g && (u.end = u.start, u.start = 0));
      }
    }
  }
  ...
  function G(e, t) {
    ...
    for (n in e) {
      if (i = h(n), r = t[i], o = e[n], Array.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), (s = we.cssHooks[i]) && "expand" in s) {
  ...
  function Q(e, t, n) {
    var i,
      ...
      for (var t = yt || $(), n = Math.max(0, l.startTime + l.duration - t), i = 1 - (n / l.duration || 0), o = 0, s = l.tweens.length; o < s; o++) {
        l.tweens[o].run(i);
      }
      ...
      createTween: function createTween(t, n) {
        var i = we.Tween(e, l.opts, t, n, l.opts.specialEasing[t] || l.opts.easing);
    ...
    for (G(c, l.opts.specialEasing); o < s; o++) {
      if (i = Q.prefilters[o].call(l, e, c, l.opts)) return ve(i.stop) && (we._queueHooks(l.elem, l.opts.queue).stop = i.stop.bind(i)), i;
    }

    return we.map(c, Y, l), ve(l.opts.start) && l.opts.start.call(e, l), l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always), we.fx.timer(we.extend(u, {
      elem: e,
      anim: l,
      queue: l.opts.queue
    })), l;
  ...
  function Z(e, t, n, r) {
    ...
    if (Array.isArray(t)) we.each(t, function (t, i) {
      n || At.test(e) ? r(e, i) : Z(e + "[" + ("object" == _typeof(i) && null != i ? t : "") + "]", i, n, r);
  ...
  we.fn = we.prototype = {
    ...
    for ("boolean" == typeof s && (l = s, s = arguments[a] || {}, a++), "object" == _typeof(s) || ve(s) || (s = {}), a === u && (s = this, a--); a < u; a++) {
      if (null != (e = arguments[a])) for (t in e) {
        n = s[t], s !== (i = e[t]) && (l && i && (we.isPlainObject(i) || (r = Array.isArray(i))) ? (r ? (r = !1, o = n && Array.isArray(n) ? n : []) : o = n && we.isPlainObject(n) ? n : {}, s[t] = we.extend(l, o, i)) : void 0 !== i && (s[t] = i));
      }
    }
    ...
    makeArray: function makeArray(e, t) {
      var n = t || [];
      return null != e && (r(Object(e)) ? we.merge(n, "string" == typeof e ? [e] : e) : ce.call(n, e)), n;
    },
  ...
  var Ce = function (e) {
    function t(e, t, n, i) {
      ...
      if (!i && ((t ? t.ownerDocument || t : M) !== q && _(t), t = t || q, I)) {
        ...
        if (T.qsa && !Y[e + " "] && (!z || !z.test(e))) {
          if (1 !== h) d = t, c = e;else if ("object" !== t.nodeName.toLowerCase()) {
            for ((a = t.getAttribute("id")) ? a = a.replace(we, Te) : t.setAttribute("id", a = R), o = (l = k(e)).length; o--;) {
              l[o] = "#" + a + " " + p(l[o]);
            }
    ...
    function h(e, t, n) {
      ...
      return t.first ? function (t, n, r) {
        ...
        if (u) {
          ...
          if (1 === t.nodeType || s) if (f = t[R] || (t[R] = {}), c = f[t.uniqueID] || (f[t.uniqueID] = {}), r && r === t.nodeName.toLowerCase()) t = t[i] || t;else {
    ...
    function v(e, t, n, r, o, s) {
      return r && !r[R] && (r = v(r)), o && !o[R] && (o = v(o, s)), i(function (i, s, a, u) {
        var l,
            ...
            x = n ? o || (i ? e : h || r) ? [] : s : v;
        if (n && n(v, x, a, u), r) for (l = y(x, p), r(l, [], a, u), c = l.length; c--;) {
          (f = l[c]) && (x[p[c]] = !(v[p[c]] = f));
        }
        ...
        if (i) {
          if (o || e) {
            ...
            for (c = x.length; c--;) {
              (f = x[c]) && (l = o ? ee(i, f) : d[c]) > -1 && (i[l] = !(s[l] = f));
            }
          }
    ...
    function x(e) {
      for (var t, n, i, r = e.length, o = C.relative[e[0].type], s = o || C.relative[" "], a = o ? 1 : 0, u = h(function (e) {
        ...
        if (n = C.relative[e[a].type]) c = [h(g(c), n)];else {
          if ((n = C.filter[e[a].type].apply(null, e[a].matches))[R]) {
            ...
            return v(a > 1 && g(c), a > 1 && p(e.slice(0, a - 1).concat({
              value: " " === e[a - 2].type ? "*" : ""
            })).replace(ae, "$1"), n, a < i && x(e.slice(a, i)), i < r && x(e = e.slice(i)), i < r && p(e));
          }
    ...
    function b(e, n) {
      var r = n.length > 0,
        ...
        for (l && (j = _s === q || _s || l); h !== w && null != (c = x[h]); h++) {
          if (o && c) {
            for (f = 0, _s || c.ownerDocument === q || (_(c), a = !I); d = e[f++];) {
              if (d(c, _s || q, a)) {
                u.push(c);
                break;
              }
    ...
    T = t.support = {}, S = t.isXML = function (e) {
      ...
      return i !== q && 9 === i.nodeType && i.documentElement ? (q = i, O = q.documentElement, I = !S(q), M !== q && (n = q.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), T.attributes = r(function (e) {
        return e.className = "i", !e.getAttribute("className");
      }), T.getElementsByTagName = r(function (e) {
        return e.appendChild(q.createComment("")), !e.getElementsByTagName("*").length;
      }), T.getElementsByClassName = me.test(q.getElementsByClassName), T.getById = r(function (e) {
      ...
      }, H = [], z = [], (T.qsa = me.test(q.querySelectorAll)) && (r(function (e) {
        ...
        t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && z.push("name" + ne + "*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && z.push(":enabled", ":disabled"), O.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(":disabled").length && z.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), z.push(",.*:");
      })), (T.matchesSelector = me.test(W = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && r(function (e) {
        T.disconnectedMatch = W.call(e, "*"), W.call(e, "[s!='']:x"), H.push("!=", oe);
      }), z = z.length && new RegExp(z.join("|")), H = H.length && new RegExp(H.join("|")), t = me.test(O.compareDocumentPosition), P = t || me.test(O.contains) ? function (e, t) {
        ...
        return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !T.sortDetached && t.compareDocumentPosition(e) === n ? e === q || e.ownerDocument === M && P(M, e) ? -1 : t === q || t.ownerDocument === M && P(M, t) ? 1 : L ? ee(L, e) - ee(L, t) : 0 : 4 & n ? -1 : 1);
      } : function (e, t) {
        if (e === t) return A = !0, 0;
        var n,
            i = 0,
            ...
            a = [e],
            u = [t];
        if (!r || !o) return e === q ? -1 : t === q ? 1 : r ? -1 : o ? 1 : L ? ee(L, e) - ee(L, t) : 0;
        if (r === o) return s(e, t);
      ...
      if ((e.ownerDocument || e) !== q && _(e), n = n.replace(ce, "='$1']"), T.matchesSelector && I && !Y[n + " "] && (!H || !H.test(n)) && (!z || !z.test(n))) try {
        var i = W.call(e, n);
      ...
      if (A = !T.detectDuplicates, L = !T.sortStable && e.slice(0), e.sort(X), A) {
        for (; t = e[r++];) {
          t === e[r] && (i = n.push(r));
        }
          ...
          return 1 === i && 0 === r ? function (e) {
            ...
            if (m) {
              ...
              if (h = [s ? m.firstChild : m.lastChild], s && v) {
                for (x = (p = (l = (c = (f = (d = m)[R] || (d[R] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === B && l[1]) && l[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (x = p = 0) || h.pop();) {
                  if (1 === d.nodeType && ++x && d === t) {
                    c[e] = [B, p, x];
                    break;
                  }
                }
              } else if (v && (x = p = (l = (c = (f = (d = t)[R] || (d[R] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === B && l[1]), !1 === x) for (; (d = ++p && d && d[g] || (x = p = 0) || h.pop()) && ((a ? d.nodeName.toLowerCase() !== y : 1 !== d.nodeType) || !++x || (v && ((c = (f = d[R] || (d[R] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [B, x]), d !== t));) {
                ;
              }
    ...
    return d.prototype = C.filters = C.pseudos, C.setFilters = new d(), k = t.tokenize = function (e, n) {
      ...
      for (a = e, u = [], l = C.preFilter; a;) {
        ...
        for (s in C.filter) {
          !(r = pe[s].exec(a)) || l[s] && !(r = l[s](r)) || (i = r.shift(), o.push({
            value: i,
            type: s,
            matches: r
          }), a = a.slice(i.length));
      ...
      if (!o) {
        for (t || (t = k(e)), n = t.length; n--;) {
          (o = x(t[n]))[R] ? i.push(o) : r.push(o);
        }

        (o = Y(e, b(r, i))).selector = e;
      }
      ...
      if (n = n || [], 1 === c.length) {
        if ((o = c[0] = c[0].slice(0)).length > 2 && "ID" === (s = o[0]).type && 9 === t.nodeType && I && C.relative[o[1].type]) {
        ...
        for (r = pe.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !C.relative[a = s.type]);) {
          if ((u = C.find[a]) && (i = u(s.matches[0].replace(xe, be), ve.test(o[0].type) && f(t.parentNode) || t))) {
      ...
      return (l || D(e, c))(i, t, !I, n, !t || ve.test(e) && f(t.parentNode) || t), n;
    }, T.sortStable = R.split("").sort(X).join("") === R, T.detectDuplicates = !!A, _(), T.sortDetached = r(function (e) {
  ...
  we.filter = function (e, t, n) {
    ...
    is: function is(e) {
      return !!s(this, "string" == typeof e && ke.test(e) ? we(e) : e || [], !1).length;
    }
  });
  var Ne,
      je = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
  (we.fn.init = function (e, t, n) {
    ...
    if (n = n || Ne, "string" == typeof e) {
      ...
      if (i[1]) {
        if (t = t instanceof we ? t[0] : t, we.merge(this, we.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : se, !0)), De.test(i[1]) && we.isPlainObject(t)) for (i in t) {
  ...
  we.fn.extend({
    ...
    we.fn[e] = function (n, i) {
      ...
      return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = we.filter(i, r)), this.length > 1 && (Ae[e] || we.uniqueSort(r), Le.test(e) && r.reverse()), this.pushStack(r);
    };
  });
  var _e = /[^\x20\t\r\n\f]+/g;
    ...
    var t,
      ...
      remove: function remove() {
        return we.each(arguments, function (e, t) {
          for (var n; (n = we.inArray(t, s, n)) > -1;) {
            s.splice(n, 1), n <= l && l--;
          }
        }), this;
      },
      ...
      var n = [["notify", "progress", we.Callbacks("memory"), we.Callbacks("memory"), 2], ["resolve", "done", we.Callbacks("once memory"), we.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", we.Callbacks("once memory"), we.Callbacks("once memory"), 1, "rejected"]],
        ...
        then: function then(t, i, r) {
            ...
            return function () {
              var a = this,
                ...
                if (!(t < s)) {
                  ...
                  f = e && ("object" == _typeof(e) || "function" == typeof e) && e.then, ve(f) ? r ? f.call(e, o(s, n, l, r), o(s, n, c, r)) : (s++, f.call(e, o(s, n, l, r), o(s, n, c, r), o(s, n, l, n.notifyWith))) : (i !== l && (a = void 0, u = [e]), (r || n.resolveWith)(a, u));
                }
              },
                  d = r ? f : function () {
                try {
                  ...
                  we.Deferred.exceptionHook && we.Deferred.exceptionHook(e, d.stackTrace), t + 1 >= s && (i !== c && (a = void 0, u = [e]), n.rejectWith(a, u));
                }
              };
          ...
          return we.Deferred(function (e) {
            n[0][3].add(o(0, e, ve(r) ? r : l, e.notifyWith)), n[1][3].add(o(0, e, ve(t) ? t : l)), n[2][3].add(o(0, e, ve(i) ? i : c));
          }).promise();
        },
  ...
  we.fn.ready = function (e) {
    ...
    ready: function ready(e) {
      (!0 === e ? --we.readyWait : we.isReady) || (we.isReady = !0, !0 !== e && --we.readyWait > 0 || Oe.resolveWith(se, [we]));
    }
  }), we.ready.then = Oe.then, "complete" === se.readyState || "loading" !== se.readyState && !se.documentElement.doScroll ? e.setTimeout(we.ready) : (se.addEventListener("DOMContentLoaded", d), e.addEventListener("load", d));
  ...
  var Ie = function Ie(e, t, n, r, o, s, a) {
    ...
    } else if (void 0 !== r && (o = !0, ve(r) || (a = !0), c && (a ? (t.call(e, r), t = null) : (c = t, t = function t(e, _t2, n) {
  ...
  g.uid = 1, g.prototype = {
    ...
    set: function set(e, t, n) {
      var i,
          r = this.cache(e);
      if ("string" == typeof t) r[h(t)] = n;else for (i in t) {
        r[h(i)] = t[i];
      }
      return r;
    },
    ...
    remove: function remove(e, t) {
      ...
      if (void 0 !== i) {
        if (void 0 !== t) {
          n = (t = Array.isArray(t) ? t.map(h) : (t = h(t)) in i ? [t] : t.match(_e) || []).length;
  ...
  we.extend({
    ...
    data: function data(e, t) {
      ...
      if (void 0 === e) {
        if (this.length && (r = Re.get(o), 1 === o.nodeType && !Pe.get(o, "hasDataAttrs"))) {
          for (n = s.length; n--;) {
            s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = h(i.slice(5)), y(o, i, r[i]));
          }
    ...
    queue: function queue(e, t, n) {
      var i;
      if (e) return t = (t || "fx") + "queue", i = Pe.get(e, t), n && (!i || Array.isArray(n) ? i = Pe.access(e, t, we.makeArray(n)) : i.push(n)), i || [];
    },
    ...
    promise: function promise(e, t) {
      ...
      for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;) {
        (n = Pe.get(o[s], e + "queueHooks")) && n.empty && (i++, n.empty.add(a));
      }
  ...
  we.event = {
    ...
    add: function add(e, t, n, i, r) {
      var o,
          ...
          g,
          m = Pe.get(e);
      if (m) for (n.handler && (n = (o = n).handler, r = o.selector), r && we.find.matchesSelector(et, r), n.guid || (n.guid = we.guid++), (u = m.events) || (u = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
        return void 0 !== we && we.event.triggered !== t.type ? we.event.dispatch.apply(e, arguments) : void 0;
      }), l = (t = (t || "").match(_e) || [""]).length; l--;) {
        p = g = (a = it.exec(t[l]) || [])[1], h = (a[2] || "").split(".").sort(), p && (f = we.event.special[p] || {}, p = (r ? f.delegateType : f.bindType) || p, f = we.event.special[p] || {}, c = we.extend({
          type: p,
          origType: g,
          data: i,
          handler: n,
          ...
          namespace: h.join(".")
        }, o), (d = u[p]) || ((d = u[p] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(e, i, h, s) || e.addEventListener && e.addEventListener(p, s)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), r ? d.splice(d.delegateCount++, 0, c) : d.push(c), we.event.global[p] = !0);
      }
    },
    remove: function remove(e, t, n, i, r) {
      ...
      if (m && (u = m.events)) {
        for (l = (t = (t || "").match(_e) || [""]).length; l--;) {
          if (a = it.exec(t[l]) || [], p = g = a[1], h = (a[2] || "").split(".").sort(), p) {
            for (f = we.event.special[p] || {}, d = u[p = (i ? f.delegateType : f.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = d.length; o--;) {
            ...
            s && !d.length && (f.teardown && !1 !== f.teardown.call(e, h, m.handle) || we.removeEvent(e, p, m.handle), delete u[p]);
          } else for (p in u) {
            we.event.remove(e, p + t[l], n, i, !0);
          }
        }

        we.isEmptyObject(u) && Pe.remove(e, "handle events");
      }
    },
    dispatch: function dispatch(e) {
      ...
      if (a.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
        for (s = we.event.handlers.call(this, a, l), t = 0; (r = s[t++]) && !a.isPropagationStopped();) {
          for (a.currentTarget = r.elem, n = 0; (o = r.handlers[n++]) && !a.isImmediatePropagationStopped();) {
            a.rnamespace && !a.rnamespace.test(o.namespace) || (a.handleObj = o, a.data = o.data, void 0 !== (i = ((we.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, u)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
          }
        }
    ...
    handlers: function handlers(e, t) {
      ...
      if (u && l.nodeType && !("click" === e.type && e.button >= 1)) for (; l !== this; l = l.parentNode || this) {
        if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
          for (o = [], s = {}, n = 0; n < u; n++) {
            void 0 === s[r = (i = t[n]).selector + " "] && (s[r] = i.needsContext ? we(r, this).index(l) > -1 : we.find(r, this, null, [l]).length), s[r] && o.push(i);
          }
  ...
  we.extend({
    ...
    clone: function clone(e, t, n) {
      ...
      if (!(ye.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || we.isXMLDoc(e))) for (s = w(a), i = 0, r = (o = w(e)).length; i < r; i++) {
        _(o[i], s[i]);
      }
      if (t) if (n) for (o = o || w(e), s = s || w(a), i = 0, r = o.length; i < r; i++) {
        A(o[i], s[i]);
      } else A(e, a);
      return (s = w(a, "script")).length > 0 && T(s, !u && w(e, "script")), a;
    },
    ...
    html: function html(e) {
      return Ie(this, function (e) {
        ...
        if ("string" == typeof e && !ot.test(e) && !Ke[(Ve.exec(e) || ["", ""])[1].toLowerCase()]) {
          e = we.htmlPrefilter(e);

          try {
            for (; n < i; n++) {
              1 === (t = this[n] || {}).nodeType && (we.cleanData(w(t, !1)), t.innerHTML = e);
            }
    ...
    we.fn[e] = function (e) {
      for (var n, i = [], r = we(e), o = r.length - 1, s = 0; s <= o; s++) {
        n = s === o ? this : this.clone(!0), we(r[s])[t](n), ce.apply(i, n.get());
      }
  ...
  !function () {
    function t() {
      if (l) {
        ...
        i = "1%" !== t.top, a = 12 === n(t.marginLeft), l.style.right = "60%", s = 36 === n(t.right), r = 36 === n(t.width), l.style.position = "absolute", o = 36 === l.offsetWidth || "absolute", et.removeChild(u), l = null;
      }
    }
  ...
  we.extend({
    ...
    style: function style(e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var r,
            ...
            u = dt.test(t),
            l = e.style;
        if (u || (t = W(a)), s = we.cssHooks[t] || we.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : l[t];
        "string" == (o = _typeof(n)) && (r = $e.exec(n)) && r[1] && (n = v(e, t, r), o = "number"), null != n && n === n && ("number" === o && (n += r && r[3] || (we.cssNumber[a] ? "" : "px")), ye.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (u ? l.setProperty(t, n) : l[t] = n));
      }
    },
    css: function css(e, t, n, i) {
      var r,
          ...
          s,
          a = h(t);
      return dt.test(t) || (t = W(a)), (s = we.cssHooks[t] || we.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = I(e, t, i)), "normal" === r && t in ht && (r = ht[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r;
    }
  }), we.each(["height", "width"], function (e, t) {
    we.cssHooks[t] = {
      get: function get(e, n, i) {
        if (n) return !ft.test(we.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? M(e, t, i) : Xe(e, pt, function () {
          return M(e, t, i);
        });
      },
      set: function set(e, n, i) {
        var r,
            ...
            a = i && R(e, t, i, s, o);
        return s && ye.scrollboxSize() === o.position && (a -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - R(e, t, "border", !1, o) - .5)), a && (r = $e.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = we.css(e, t)), P(e, n, a);
      }
    };
  }), we.cssHooks.marginLeft = z(ye.reliableMarginLeft, function (e, t) {
    ...
    }, "margin" !== e && (we.cssHooks[e + t].set = P);
  }), we.fn.extend({
  ...
  we.Animation = we.extend(Q, {
    tweeners: {
      "*": [function (e, t) {
        ...
        return v(n.elem, e, $e.exec(t), n), n;
      }]
    },
    tweener: function tweener(e, t) {
      ve(e) ? (t = e, e = ["*"]) : e = e.match(_e);
    ...
    var i = e && "object" == _typeof(e) ? we.extend({}, e) : {
    ...
    finish: function finish(e) {
      return !1 !== e && (e = e || "fx"), this.each(function () {
        ...
        for (n.finish = !0, we.queue(this, e, []), r && r.stop && r.stop.call(this, !0), t = o.length; t--;) {
  ...
  we.fn.extend({
    ...
    attr: function attr(e, t, n) {
      var i,
          r,
          o = e.nodeType;
      if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? we.prop(e, t, n) : (1 === o && we.isXMLDoc(e) || (r = we.attrHooks[t.toLowerCase()] || (we.expr.match.bool.test(t) ? wt : void 0)), void 0 !== n ? null === n ? void we.removeAttr(e, t) : r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : r && "get" in r && null !== (i = r.get(e, t)) ? i : null == (i = we.find.attr(e, t)) ? void 0 : i);
    },
    attrHooks: {
      type: {
  ...
  we.fn.extend({
    ...
    toggleClass: function toggleClass(e, t) {
      ...
      return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : ve(e) ? this.each(function (n) {
        ...
        var t, r, o, s;
        if (i) for (r = 0, o = we(this), s = K(e); t = s[r++];) {
  ...
  we.fn.extend({
    val: function val(e) {
      ...
      })) : r ? (t = we.valHooks[r.type] || we.valHooks[r.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(r, "value")) ? n : "string" == typeof (n = r.value) ? n.replace(St, "") : null == n ? "" : n : void 0;
    }
  }), we.extend({
    valHooks: {
      option: {
      ...
      select: {
        ...
        set: function set(e, t) {
          for (var n, i, r = e.options, o = we.makeArray(t), s = r.length; s--;) {
            ((i = r[s]).selected = we.inArray(we.valHooks.option.get(i), o) > -1) && (n = !0);
          }
  ...
  we.extend(we.event, {
    trigger: function trigger(t, n, i, r) {
      ...
      if (s = d = a = i = i || se, 3 !== i.nodeType && 8 !== i.nodeType && !kt.test(h + we.event.triggered) && (h.indexOf(".") > -1 && (h = (g = h.split(".")).shift(), g.sort()), l = h.indexOf(":") < 0 && "on" + h, t = t[we.expando] ? t : new we.Event(h, "object" == _typeof(t) && t), t.isTrigger = r ? 2 : 3, t.namespace = g.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : we.makeArray(n, [t]), f = we.event.special[h] || {}, r || !f.trigger || !1 !== f.trigger.apply(i, n))) {
        if (!r && !f.noBubble && !xe(i)) {
          for (u = f.delegateType || h, kt.test(u + h) || (s = s.parentNode); s; s = s.parentNode) {
            p.push(s), a = s;
          }

          a === (i.ownerDocument || se) && p.push(a.defaultView || a.parentWindow || e);
        }

        for (o = 0; (s = p[o++]) && !t.isPropagationStopped();) {
          d = s, t.type = o > 1 ? u : f.bindType || h, (c = (Pe.get(s, "events") || {})[t.type] && Pe.get(s, "handle")) && c.apply(s, n), (c = l && s[l]) && c.apply && We(s) && (t.result = c.apply(s, n), !1 === t.result && t.preventDefault());
        }

        return t.type = h, r || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(p.pop(), n) || !We(i) || l && ve(i[h]) && !xe(i) && ((a = i[l]) && (i[l] = null), we.event.triggered = h, t.isPropagationStopped() && d.addEventListener(h, Dt), i[h](), t.isPropagationStopped() && d.removeEventListener(h, Dt), we.event.triggered = void 0, a && (i[l] = a)), t.result;
      }
    },
  ...
  we.param = function (e, t) {
    ...
    serializeArray: function serializeArray() {
      return this.map(function () {
        ...
        var e = this.type;
        return this.name && !we(this).is(":disabled") && Ot.test(this.nodeName) && !qt.test(e) && (this.checked || !Qe.test(e));
      }).map(function (e, t) {
        var n = we(this).val();
  ...
  Ut.href = Nt.href, we.extend({
    ...
    ajax: function ajax(t, n) {
      function i(t, n, i, a) {
        var l,
            ...
            w,
            T = n;
        c || (c = !0, u && e.clearTimeout(u), r = void 0, s = a || "", C.readyState = t > 0 ? 4 : 0, l = t >= 200 && t < 300 || 304 === t, i && (b = ie(h, C, i)), b = re(h, b, C, l), l ? (h.ifModified && ((w = C.getResponseHeader("Last-Modified")) && (we.lastModified[o] = w), (w = C.getResponseHeader("etag")) && (we.etag[o] = w)), 204 === t || "HEAD" === h.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = b.state, d = b.data, l = !(p = b.error))) : (p = T, !t && T || (T = "error", t < 0 && (t = 0))), C.status = t, C.statusText = (n || T) + "", l ? y.resolveWith(g, [d, T, C]) : y.rejectWith(g, [C, T, p]), C.statusCode(x), x = void 0, f && m.trigger(l ? "ajaxSuccess" : "ajaxError", [C, h, l ? d : p]), v.fireWith(g, [C, T]), f && (m.trigger("ajaxComplete", [C, h]), --we.active || we.event.trigger("ajaxStop")));
      }
      ...
      if (y.promise(C), h.url = ((t || h.url || Nt.href) + "").replace(Mt, Nt.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(_e) || [""], null == h.crossDomain) {
      ...
      if (h.data && h.processData && "string" != typeof h.data && (h.data = we.param(h.data, h.traditional)), te(Bt, h, n, C), c) return C;
      (f = we.event && h.global) && 0 == we.active++ && we.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Rt.test(h.type), o = h.url.replace(zt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(It, "+")) : (p = h.url.slice(o.length), h.data && (h.processData || "string" == typeof h.data) && (o += (Lt.test(o) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (o = o.replace(Ht, "$1"), p = (Lt.test(o) ? "&" : "?") + "_=" + jt++ + p), h.url = o + p), h.ifModified && (we.lastModified[o] && C.setRequestHeader("If-Modified-Since", we.lastModified[o]), we.etag[o] && C.setRequestHeader("If-None-Match", we.etag[o])), (h.data && h.hasContent && !1 !== h.contentType || n.contentType) && C.setRequestHeader("Content-Type", h.contentType), C.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + $t + "; q=0.01" : "") : h.accepts["*"]);
      ...
      if (T = "abort", v.add(h.complete), C.done(h.success), C.fail(h.error), r = te(Ft, h, n, C)) {
    ...
    we[t] = function (e, n, i, r) {
      return ve(n) && (r = r || i, i = n, n = void 0), we.ajax(we.extend({
        url: e,
        type: t,
        dataType: r,
        data: n,
  ...
  ye.cors = !!Xt && "withCredentials" in Xt, ye.ajax = Xt = !!Xt, we.ajaxTransport(function (t) {
    var _n, i;
    ...
    if (ye.cors || Xt && !t.crossDomain) return {
      send: function send(r, o) {
        ...
        _n = function n(e) {
          return function () {
            _n && (_n = i = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Yt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
              binary: a.response
            } : {
              text: a.responseText
  ...
  we.ajaxSetup({
    ...
    if (a || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = ve(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Qt, "$1" + r) : !1 !== t.jsonp && (t.url += (Lt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function () {
      return s || we.error(r + " was not called"), s[0];
    }, t.dataTypes[0] = "json", o = e[r], e[r] = function () {
      s = arguments;
    }, i.always(function () {
      void 0 === o ? we(e).removeProp(r) : e[r] = o, t[r] && (t.jsonpCallback = n.jsonpCallback, Gt.push(r)), s && ve(o) && o(s[0]), s = o = void 0;
    }), "script";
    ...
    var i, r, o;
    return t || (ye.createHTMLDocument ? ((i = (t = se.implementation.createHTMLDocument("")).createElement("base")).href = se.location.href, t.head.appendChild(i)) : t = se), r = De.exec(e), o = !n && [], r ? [t.createElement(r[1])] : (r = C([e], t, o), o && o.length && we(o).remove(), we.merge([], r.childNodes));
    ...
    var i,
        ...
        s = this,
        a = e.indexOf(" ");
    return a > -1 && (i = V(e.slice(a)), e = e.slice(0, a)), ve(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (r = "POST"), s.length > 0 && we.ajax({
      url: e,
      type: r || "GET",
      dataType: "html",
      data: t
    ...
    setOffset: function setOffset(e, t, n) {
      var i,
          ...
          c = we(e),
          f = {};
      "static" === l && (e.style.position = "relative"), a = c.offset(), o = we.css(e, "top"), u = we.css(e, "left"), ("absolute" === l || "fixed" === l) && (o + u).indexOf("auto") > -1 ? (s = (i = c.position()).top, r = i.left) : (s = parseFloat(o) || 0, r = parseFloat(u) || 0), ve(t) && (t = t.call(e, n, we.extend({}, a))), null != t.top && (f.top = t.top - a.top + s), null != t.left && (f.left = t.left - a.left + r), "using" in t ? t.using.call(e, f) : c.css(f);
    }
  }, we.fn.extend({
    ...
    position: function position() {
      if (this[0]) {
        ...
        if ("fixed" === we.css(i, "position")) t = i.getBoundingClientRect();else {
    ...
    we.cssHooks[t] = z(ye.pixelPosition, function (e, n) {
      if (n) return n = I(e, t), ut.test(n) ? we(e).position()[t] + "px" : n;
    });
  }), we.each({
    Height: "height",
    Width: "width"
    ...
    we.each({
      ...
      we.fn[i] = function (r, o) {
        ...
        return Ie(this, function (t, n, r) {
          var o;
          return xe(t) ? 0 === i.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (o = t.documentElement, Math.max(t.body["scroll" + e], o["scroll" + e], t.body["offset" + e], o["offset" + e], o["client" + e])) : void 0 === r ? we.css(t, n, a) : we.style(t, n, r, a);
        }, t, s ? r : void 0, s);
      };
    });
    ...
    var n, i, r;
    if ("string" == typeof t && (n = e[t], t = e, e = n), ve(e)) return i = ue.call(arguments, 2), r = function r() {
  ...
  }, we.isArray = Array.isArray, we.parseJSON = JSON.parse, we.nodeName = o, we.isFunction = ve, we.isWindow = xe, we.camelCase = h, we.type = i, we.now = Date.now, we.isNumeric = function (e) {
    var t = we.type(e);
  ...
  return we.noConflict = function (t) {
    return e.$ === we && (e.$ = Jt), t && e.jQuery === we && (e.jQuery = Vt), we;
  }, t || (e.jQuery = e.$ = we), we;
}), function (e, t) {
  ...
  function n(n, o, a) {
    function u(e, t, i) {
      ...
      return e.each(function (e, u) {
        var l = a.data(u, n);
        if (!l) return void s(n + " not initialized. Cannot call methods, i.e. " + o);
        var c = l[t];
    ...
    (a = a || t || e.jQuery) && (o.prototype.option || (o.prototype.option = function (e) {
      ...
      if ("string" == typeof e) {
        return u(this, e, r.call(arguments, 1));
      }
  ...
  function o(t) {
    if (r(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == _typeof(t) && t.nodeType) {
      var o = i(t);
      if ("none" == o.display) return n();
      var a = {};
      a.width = t.offsetWidth, a.height = t.offsetHeight;

      for (var c = a.isBorderBox = "border-box" == o.boxSizing, f = 0; l > f; f++) {
        var d = u[f],
            p = o[d],
            h = parseFloat(p);
        a[d] = isNaN(h) ? 0 : h;
      ...
      var C = e(o.height);
      return !1 !== C && (a.height = C + (w ? 0 : m + b)), a.innerWidth = a.width - (g + x), a.innerHeight = a.height - (m + b), a.outerWidth = a.width + y, a.outerHeight = a.height + v, a;
    }
  }

  var s,
      a = "undefined" == typeof console ? t : function (e) {
    console.error(e);
  },
  ...
  n.makeArray = function (e) {
    return Array.isArray(e) ? e : null === e || void 0 === e ? [] : "object" == _typeof(e) && "number" == typeof e.length ? i.call(e) : [e];
  ...
  i.extend(p, t.prototype), p.option = function (e) {
    ...
    var n = s(o);
    return n.defaults = i.extend({}, o.defaults), i.extend(n.defaults, t), n.compatOptions = i.extend({}, o.compatOptions), n.namespace = e, n.data = o.data, n.Item = s(r), i.htmlInit(n, e), l && l.bridget && l.bridget(e, n), n;
  };
  var h = {
    ms: 1,
    s: 1e3
  ...
  "function" == typeof define && define.amd ? define(["outlayer/outlayer", "get-size/get-size"], t) : "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = t(require("outlayer"), require("get-size")) : e.Masonry = t(e.Outlayer, e.getSize);
}(window, function (e, t) {
  ...
  return i._resetLayout = function () {
    ...
    for (var r = this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition", o = this[r](i, e), s = {
      ...
      y: o.y
    }, a = o.y + e.size.outerHeight, u = i + o.col, l = o.col; u > l; l++) {
      this.colYs[l] = a;
    }
    ...
    for (var l = this._getOption("originTop"), c = (l ? i.top : i.bottom) + n.outerHeight, f = a; u >= f; f++) {
